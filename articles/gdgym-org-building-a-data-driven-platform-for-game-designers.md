...
To deepen my understanding of these areas and stay up to date with modern technologies and methodologies, I developed GDGym.org during my postgraduate studies in Game Design at IADE University in Lisbon. Today, I continue to maintain and expand the platform as an independent side project.
GDGym.org is a platform designed for game designers and game design students. The website combines characteristics of a media platform and a user-generated content platform. It helps users analyze existing games, understand game design patterns, and generate ideas for new game concepts.
Users can:
Explore game deconstructions  to understand how successful games are structured.
Discover alternative implementations of existing game elements.
Analyze how specific mechanics and design patterns are used across different games. Try Core Loop for example.
...
To attract new users, I create educational content related to game design on YouTube.
